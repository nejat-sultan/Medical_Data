...
async def scrape_channel(client, channel_username, writer, media_dir):
    try:
        ...
        # Limit to scraping only 100 messages (you can adjust this as needed)
        message_count = 0
        async for message in client.iter_messages(entity):
            ...
            # Introduce a small delay between messages to avoid API rate limits
...
async def main():
    try:
        ...
        with open('scraped_data.csv', 'a', newline='', encoding='utf-8') as file:  # Changed file name
            ...
            # Specify the channel you want to scrape
            channel = '@DoctorsET'  # Change this to the channel you want to scrape
